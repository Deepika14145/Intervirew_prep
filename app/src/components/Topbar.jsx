...
export default function Topbar({ breadcrumbs = [], user, onMenuClick }) {
  ...
  return (
    <header className={styles.topbar}>
      ...
      <div className={styles.right}>
        <button className={styles.iconBtn} aria-label="Notifications" onClick={() => navigate('/notifications')}>🔔</button>
